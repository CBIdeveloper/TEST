...
const x = 100, R = e.forwardRef((n, k) => {
  S(P);
  const f = e.useRef(null), o = e.useRef(null);
  let s = e.useRef(null), i = e.useRef(!1), c = e.useRef(null);
  const { uploadRef: r } = n, d = r.current;
  let [I, E] = e.useState(!1);
  const g = e.useMemo(() => new _("en"), []), u = K(), N = u.toLanguageString(v, m[v]), [O, z] = e.useState(
  ...
  const D = e.useCallback(
    (t) => (/* @__PURE__ */ new Date()).getTime() - (t || /* @__PURE__ */ new Date()).getTime() > x,
    []
  ), Z = e.useCallback(
    (t) => {
      t.preventDefault();
      let l = t.dataTransfer.files;
      l.length > 0 && !n.disabled && r && r.current && (r.current.onAdd && (t.preventDefault(), r.current.onAdd(l)), n.onDrop && n.onDrop.call(void 0, t));
    },
  ...
  return /* @__PURE__ */ e.createElement(
    ...
    /* @__PURE__ */ e.createElement(
      ...
      /* @__PURE__ */ e.createElement(A, { name: "upload", icon: M, className: "k-dropzone-icon", size: "xxxlarge" }),
      /* @__PURE__ */ e.createElement("span", { className: "k-dropzone-hint" }, h),
      /* @__PURE__ */ e.createElement("span", { className: "k-dropzone-note" }, T)
    )
  );
}), W = {
  id: a.string,
  tabIndex: a.number,
  editorRef: a.oneOfType([
    a.func,
