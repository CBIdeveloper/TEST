...
class MultipleFileInput2 extends React.PureComponent {
  constructor(props) {
    super(props);
    this.state = { fileKey: '', coverData: 'yes' };
  ...
  handleRadioChange = (event) => {
    this.setState({ coverData: event.target.value });
    this.props.onCoverDataChange(event.target.value);
  };
      ...
      <div className="multiple-file-input">
        ...
        <div className="input-container">
          ...
          <div className="message-section">
            ...
            <div className='cover-data-container'>
              <span className="cover-data">是否覆蓋既有資料</span>
              <div>
                <label className='option'>
                  <input
                    type="radio"
                    value="yes"
                    checked={this.state.coverData === 'yes'}
                ...
                <label className='option'>
                  <input
                    type="radio"
                    value="no"
                    checked={this.state.coverData === 'no'}
                    onChange={this.handleRadioChange}
                  />
                  否
                </label>
...
MultipleFileInput2.defaultProps = {
  inputValue: '',
  touched: {},
  errors: {},
  errorMessage: '',
...
export default withRouter(
  connect(mapStateToProps, mapDispatchToProps)(MultipleFileInput2),
);
