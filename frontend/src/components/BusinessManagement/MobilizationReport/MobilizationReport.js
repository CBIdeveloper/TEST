...
import MobilizationReportTable from '../../../utils/tables/businessManagement/SubMenuTable/MobilizationReportTable';
...
import './MobilizationReport.scss';

class MobilizationReport extends React.PureComponent {
  constructor(props) {
    super(props);
    this.state = {
      title: '',
    ...
    this.table = new MobilizationReportTable(
      this.setTableData,
      this.setTableCount,
    );
    this.table.typeId = 10;
  }
  ...
  render() {
    ...
    return (
      <div className="mobilization-report">
        <div className="title-container">
          <SectionTitle
            title={
              props.language.businessManagement.subMenus.mobilizationReport
            }
          />
          <ButtonDiv display={userHasRole(145)}>
            <NavLink
              to={`${props.location.pathname}/${Path.addMobilizationReportPath}`}
...
export default withRouter(
  connect(mapStateToProps, mapDispatchToProps)(MobilizationReport),
);
