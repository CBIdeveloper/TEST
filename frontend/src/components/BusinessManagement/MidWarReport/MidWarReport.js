...
import MidWarReportTable from '../../../utils/tables/businessManagement/SubMenuTable/MidWarReportTable';
...
import './MidWarReport.scss';

class MidWarReport extends React.PureComponent {
  constructor(props) {
    super(props);
    this.state = {
      title: '',
    ...
    this.table = new MidWarReportTable(this.setTableData, this.setTableCount);
    this.table.typeId = 11;
  }
  ...
  render() {
    ...
    return (
      <div className="mid-war-report">
        <div className="title-container">
          <SectionTitle
            title={props.language.businessManagement.subMenus.midWarReport}
          />
          <ButtonDiv display={userHasRole(148)}>
            <NavLink
              to={`${props.location.pathname}/${Path.addMidWarReportPath}`}
...
export default withRouter(
  connect(mapStateToProps, mapDispatchToProps)(MidWarReport),
);
