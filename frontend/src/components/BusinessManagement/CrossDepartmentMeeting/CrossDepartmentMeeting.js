...
import CrossDepartmentMeetingTable from '../../../utils/tables/businessManagement/SubMenuTable/CrossDepartmentMeetingTable';
...
import './CrossDepartmentMeeting.scss';

class CrossDepartmentMeeting extends React.PureComponent {
  constructor(props) {
    super(props);
    this.state = {
      title: '',
    ...
    this.table = new CrossDepartmentMeetingTable(
      this.setTableData,
      this.setTableCount,
    );
    this.table.typeId = 2;
  ...
  render() {
    ...
    return (
      <div className="cross-department-meeting">
        <div className="title-container">
          <SectionTitle
            title={
              props.language.businessManagement.subMenus.crossDepartmentMeeting
            }
          />
          <ButtonDiv display={userHasRole(121)}>
            <NavLink
              to={`${props.location.pathname}/${Path.addCrossDepartmentMeetingPath}`}
...
CrossDepartmentMeeting.propTypes = {
...
export default withRouter(
  connect(mapStateToProps, mapDispatchToProps)(CrossDepartmentMeeting),
);
