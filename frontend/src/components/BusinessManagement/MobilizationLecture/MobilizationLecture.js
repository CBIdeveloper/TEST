...
import MobilizationLectureTable from '../../../utils/tables/businessManagement/SubMenuTable/MobilizationLectureTable';
...
import './MobilizationLecture.scss';

class MobilizationLecture extends React.PureComponent {
  constructor(props) {
    super(props);
    this.state = {
      title: '',
    ...
    this.table = new MobilizationLectureTable(
      this.setTableData,
      this.setTableCount,
    );
    this.table.typeId = 8;
  ...
  render() {
    ...
    return (
      <div className="mobilization-lecture">
        <div className="title-container">
          <SectionTitle
            title={
              props.language.businessManagement.subMenus.mobilizationLecture
            }
          />
          <ButtonDiv display={userHasRole(139)}>
            <NavLink
              to={`${props.location.pathname}/${Path.addMobilizationLecturePath}`}
...
export default withRouter(
  connect(mapStateToProps, mapDispatchToProps)(MobilizationLecture),
);
