...
import MobilizationCategorizationTable from '../../../utils/tables/businessManagement/SubMenuTable/MobilizationCategorizationTable';
...
import './MobilizationCategorization.scss';

class MobilizationCategorization extends React.PureComponent {
  constructor(props) {
    super(props);
    this.state = {
      title: '',
    ...
    this.table = new MobilizationCategorizationTable(
      this.setTableData,
      this.setTableCount,
    );
    this.table.typeId = 4;
  ...
  render() {
    ...
    return (
      <div className="mobilization-categorization">
        <div className="title-container">
          <SectionTitle
            title={
              props.language.businessManagement.subMenus
                .mobilizationCategorization
            }
          />
          <ButtonDiv display={userHasRole(127)}>
            <NavLink
              to={`${props.location.pathname}/${Path.addMobilizationCategorizationPath}`}
...
MobilizationCategorization.propTypes = {
...
export default withRouter(
  connect(mapStateToProps, mapDispatchToProps)(MobilizationCategorization),
);
