...
import MobilizationAccessTable from '../../../utils/tables/businessManagement/SubMenuTable/MobilizationAccessTable';
...
import './MobilizationAccess.scss';

class MobilizationAccess extends React.PureComponent {
  constructor(props) {
    super(props);
    this.state = {
      title: '',
    ...
    this.table = new MobilizationAccessTable(
      this.setTableData,
      this.setTableCount,
    );
    this.table.typeId = 5;
  ...
  render() {
    ...
    return (
      <div className="mobilization-access">
        <div className="title-container">
          <SectionTitle
            title={
              props.language.businessManagement.subMenus.mobilizationAccess
            }
          />
          <ButtonDiv display={userHasRole(130)}>
            <NavLink
              to={`${props.location.pathname}/${Path.addMobilizationAccessPath}`}
...
export default withRouter(
  connect(mapStateToProps, mapDispatchToProps)(MobilizationAccess),
);
