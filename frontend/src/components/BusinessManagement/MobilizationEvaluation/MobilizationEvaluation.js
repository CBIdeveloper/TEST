...
import MobilizationEvaluationTable from '../../../utils/tables/businessManagement/SubMenuTable/MobilizationEvaluationTable';
...
import './MobilizationEvaluation.scss';

class MobilizationEvaluation extends React.PureComponent {
  constructor(props) {
    super(props);
    this.state = {
      title: '',
    ...
    this.table = new MobilizationEvaluationTable(
      this.setTableData,
      this.setTableCount,
    );
    this.table.typeId = 6;
  ...
  render() {
    ...
    return (
      <div className="mobilization-evaluation">
        <div className="title-container">
          <SectionTitle
            title={
              props.language.businessManagement.subMenus.mobilizationEvaluation
            }
          />
          <ButtonDiv display={userHasRole(133)}>
            <NavLink
              to={`${props.location.pathname}/${Path.addMobilizationEvaluationPath}`}
...
MobilizationEvaluation.propTypes = {
...
export default withRouter(
  connect(mapStateToProps, mapDispatchToProps)(MobilizationEvaluation),
);
