...
const hrHeavymachinerydriverConfig = new BraidingItem({
  ...
  criteriaList: [
    ...
    },
    {
      ...
      type: 'nvarchar',
      length: 30,
      remark: '【系統判斷】\n由系統依本編管類別【徵用機關】欄位與【編管類別-工程重機械】之【徵用機關】欄位比對相同後，\n回饋【編管類別-工程重機械】之【徵用類別】欄位資料',
    },
    {
      id: 5,
      chineseField: '演訓時間(起)',
    ...
    },
    {
      ...
      type: 'nvarchar',
      length: 50,
      remark: '【必填】\n由營建署依物力簽證需求後掌握各縣市併同工程重機械受徵用之操作人員填入徵用機關',
    },
    {
      id: 14,
      chineseField: '徵用專長',
      ...
      type: 'nvarchar',
      length: 1000,
      remark: '【必填】\n1.由營建署依物力簽證需求後掌握各縣市併同工程重機械受徵用之操作人員填入徵用專長\n2.【BI】儀表板-動員指標：分析以單1專長人數',
    },
    {
      id: 15,
      chineseField: '異動時間',
