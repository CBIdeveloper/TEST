...
const hrCarRepairmanConfig = new BraidingItem({
  id: 14,
  code: '009',
  name: '汽車修護人員',
  type: '人力',
  ...
  fetchDetailData: (id) => ApiService.hrCarRepairman.readHrCarRepairmanById(id),
  fetchCategoryData: ApiService.hrCarRepairman.readHrCarRepairmanPagination,
  queryCategoryData:
    ApiService.hrCarRepairman.readHrCarRepairmanQueryPagination,
  fetchPlanData: ({ pid }) =>
    ApiService.hrCarRepairmanPlan.readHrCarRepairmanPlanByPid(pid),

  planDataModel: HrCarRepairmanPlanResponse,

  fetchUniqueDetailData: (id) =>
    ApiService.hrCarRepairman.readUniqueHrCarRepairmanById(id),
  fetchUniqueCategoryData:
    ApiService.hrCarRepairman.readUniqueHrCarRepairmanPagination,
  queryUniqueCategoryData:
    ApiService.hrCarRepairman.readUniqueHrCarRepairmanQueryPagination,
  ...
  criteriaList: [
    ...
    },
    {
      ...
      length: 30,
      remark:
        '目前屬單一類型，為維持後續系統分析彈性，仍由機關統一填入「汽車修護」',
    },
    {
      id: 21,
      chineseField: '編管機構',
...
export default hrCarRepairmanConfig;
