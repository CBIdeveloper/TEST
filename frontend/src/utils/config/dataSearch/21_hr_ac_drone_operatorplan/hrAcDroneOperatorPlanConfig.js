...
const hrAcDroneOperatorConfig = new BraidingItem({
  ...
  criteriaList: [
    ...
    },
    {
      ...
      type: 'nvarchar',
      length: 30,
      remark: '【系統判斷】\n由系統依本編管類別【徵用機關】欄位與【編管類別-航空器、無人機】之【徵用機關】欄位比對相同後，\n回饋【編管類別-航空器、無人機】之【徵用類別】欄位資料',
    },
    {
      id: 5,
      chineseField: '演訓時間(起)',
    ...
    },
    {
      ...
      type: 'nvarchar',
      length: 10,
      remark: '【系統判斷】\n由系統依本編管類別【徵用機關】欄位與【編管類別-航空器、無人機】之【徵用機關】欄位比對相同後，\n回饋【編管類別-航空器、無人機】之【徵用鄉鎮市區別】欄位資料',
    },
    {
      id: 10,
      chineseField: '演訓村里別',
    ...
    },
    {
      ...
      type: 'nvarchar',
      length: 50,
      remark: '【必填】\n由民航局依物力簽證需求後掌握各航空公司、無人機法人併同航空器或無人機具受徵用之操作人員填入徵用機關',
    },
    {
      id: 14,
      chineseField: '徵用類型',
      ...
      type: 'nvarchar',
      length: 50,
      remark: '【系統判斷】\n由系統比對編管類別【民用航空器操作人員】之【編管類型】欄位回饋資料',
    },
    {
      id: 15,
      chineseField: '異動時間',
