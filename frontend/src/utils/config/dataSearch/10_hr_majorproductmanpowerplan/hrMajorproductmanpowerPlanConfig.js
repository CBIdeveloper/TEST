...
const hrMajorproductmanpowerConfig = new BraidingItem({
  id: 10,
  code: '906',
  name: '重要生產人力(演訓人力)',
  type: '人力',
  ...
  mobilizationClassification: '重要生產人力',
  mobilizationClassificationId: 7,
  ...
  fetchDetailData: (id) =>
    ApiService.hrMajorproductmanpower.readHrMajorproductmanpowerById(id),
  fetchCategoryData:
    ApiService.hrMajorproductmanpower.readHrMajorproductmanpowerPagination,
  queryCategoryData:
    ApiService.hrMajorproductmanpower.readHrMajorproductmanpowerQueryPagination,
  fetchPlanData: ({ pid }) =>
    ApiService.hrMajorproductmanpowerPlan.readHrMajorproductmanpowerPlanByPid(
      pid,
    ),

  planDataModel: HrMajorproductmanpowerPlanResponse,

  fetchUniqueDetailData: (id) =>
    ApiService.hrMajorproductmanpower.readUniqueHrMajorproductmanpowerById(id),
  fetchUniqueCategoryData:
    ApiService.hrMajorproductmanpower
...
export default hrMajorproductmanpowerConfig;
