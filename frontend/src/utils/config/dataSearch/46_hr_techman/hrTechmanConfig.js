...
const hrTechmanConfig = new BraidingItem({
  id: 46,
  code: '040',
  name: '科技人力',
  type: '人力',
  ...
  mobilizationClassification: '科技人力',
  mobilizationClassificationId: 39,
  firstLevelAgency: '國科會',
  firstLevelAgencyId: '',
  secondaryAgency: '資訊處',
  secondaryAgencyId: '',

  fetchDetailData: (id) => ApiService.hrTechman.readHrTechmanById(id),
  fetchCategoryData: ApiService.hrTechman.readHrTechmanPagination,
  queryCategoryData: ApiService.hrTechman.readHrTechmanQueryPagination,
  fetchPlanData: ({ pid }) => ApiService.hrTechmanPlan.readHrTechmanPlanByPid(pid),

  planDataModel: HrTechmanPlanResponse,

  fetchUniqueDetailData: (id) => ApiService.hrTechman.readUniqueHrTechmanById(id),
  fetchUniqueCategoryData: ApiService.hrTechman.readUniqueHrTechmanPagination,
  queryUniqueCategoryData: ApiService.hrTechman.readUniqueHrTechmanQueryPagination,
  ...
  configList: [
    ...
    new ConfigListItem({
      ...
      keyList: [
        ...
        new KeyListItem({ key: 'education', keyTitle: '學歷' }),
        new KeyListItem({ key: 'works', keyTitle: '著作' }),
      ],
    }),
  ],
  planConfigList: [
  ...
  criteriaList: [
    ...
    },
    {
      ...
      type: 'nvarchar',
      length: 1000,
      remark: '【必填】\n1.依「科技人才分類代碼表」填入可複數專長資料\n2.【BI】儀表板-編管指標：分析以1對多人次列計\n3.【BI】查詢報表-納入篩選條件分析，提供關鍵字搜尋',
    },
    {
      id: 29,
      chineseField: '學歷',
      englishField: 'education',
      dataType: '人力資訊',
      type: 'nvarchar',
      length: 30,
      remark: '',
...
export default hrTechmanConfig;
