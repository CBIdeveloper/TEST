...
const hrMajorproductmanpowerConfig = new BraidingItem({
  ...
  criteriaList: [
    ...
    },
    {
      ...
      type: 'nvarchar',
      length: 30,
      remark: '依「年度重要生產人力動員準備分類計畫」填入職類',
    },
    {
      id: 20,
      chineseField: '編管機構',
      ...
      type: 'nvarchar',
      length: 50,
      remark: '生產事業機構-公司(工廠)完整名稱\n如區分不同廠區，於公司名稱後加註可識別工廠之銜稱',
    },
    {
      id: 21,
      chineseField: '編管地點',
