...
const hrTrafficmanpowerConfig = new BraidingItem({
  id: 5,
  code: '003',
  name: '交通人力',
  type: '人力',
  ...
  mobilizationClassification: '交通人力',
  mobilizationClassificationId: 4,
  ...
  fetchDetailData: (id) =>
    ApiService.hrTrafficmanpower.readHrTrafficmanpowerById(id),
  fetchCategoryData:
    ApiService.hrTrafficmanpower.readHrTrafficmanpowerPagination,
  queryCategoryData:
    ApiService.hrTrafficmanpower.readHrTrafficmanpowerQueryPagination,
  fetchPlanData: ({ pid }) =>
    ApiService.hrTrafficmanpowerPlan.readHrTrafficmanpowerPlanByPid(pid),

  planDataModel: HrTrafficmanpowerPlanResponse,

  fetchUniqueDetailData: (id) =>
    ApiService.hrTrafficmanpower.readUniqueHrTrafficmanpowerById(id),
  fetchUniqueCategoryData:
    ApiService.hrTrafficmanpower.readUniqueHrTrafficmanpowerPagination,
  queryUniqueCategoryData:
    ApiService.hrTrafficmanpower.readUniqueHrTrafficmanpowerQueryPagination,
  ...
  configList: [
    ...
    new ConfigListItem({
      ...
      keyList: [
        ...
        new KeyListItem({ key: 'organDist', keyTitle: '編組區分' }),
...
export default hrTrafficmanpowerConfig;
