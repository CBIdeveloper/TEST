...
import SystemSubMenuActionCell from '../../../../lib/components/tableCells/SystemSubMenuActionCell/SystemSubMenuActionCell';

import ApiService from '../../../api/ApiService';
import QueryHelper from '../../../helper/QueryHelper';

class SystemSubMenuTable extends BaseTable {
  ...
  queryPrefix = () =>
    QueryHelper.equal('parentMenuId', this.parentMenuId, 'number');
}

export default SystemSubMenuTable;
