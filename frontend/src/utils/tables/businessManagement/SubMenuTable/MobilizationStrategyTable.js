...
class MobilizationStrategyTable extends BusinessManagementTable {
  getTableTitle = () => '動員方案審議列表';
  ...
  getTableHeader = () => [
    ...
    },
    {
      ...
      getProps: () => ({
        ...
        editPagePath: Path.editMobilizationStrategyPath,
        displayEdit: userHasRole(125),
        displayDelete: userHasRole(126),
      }),
    },
  ];
}

export default MobilizationStrategyTable;
