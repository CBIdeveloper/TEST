...
class MobilizationEvaluationTable extends BusinessManagementTable {
  getTableTitle = () => '動員業務訪評列表';
  ...
  getTableHeader = () => [
    ...
    },
    {
      ...
      getProps: () => ({
        ...
        editPagePath: Path.editMobilizationEvaluationPath,
        displayEdit: userHasRole(134),
        displayDelete: userHasRole(135),
      }),
    },
  ];
}

export default MobilizationEvaluationTable;
