...
class MidWarReportTable extends BusinessManagementTable {
  getTableTitle = () => '戰綜會報列表';
  ...
  getTableHeader = () => [
    ...
    },
    {
      ...
      getProps: () => ({
        ...
        editPagePath: Path.editMidWarReportPath,
        displayEdit: userHasRole(149),
        displayDelete: userHasRole(150),
      }),
    },
  ];
}

export default MidWarReportTable;
