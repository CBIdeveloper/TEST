...
class MobilizationLectureTable extends BusinessManagementTable {
  getTableTitle = () => '動員講習培訓列表';
  ...
  getTableHeader = () => [
    ...
    },
    {
      ...
      getProps: () => ({
        ...
        editPagePath: Path.editMobilizationLecturePath,
        displayEdit: userHasRole(140),
        displayDelete: userHasRole(141),
      }),
    },
  ];
}

export default MobilizationLectureTable;
